...
import { Share2, Link2, ChevronLeft, Code, Zap, Download } from 'lucide-react';
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-black overflow-hidden intro-slide">
            ...
            <div className="absolute top-4 left-4 right-4 flex justify-between items-center z-30">
                ...
                <div className="flex items-center gap-2">
                    <Image src="/icons/icpchue.svg" alt="ICPC HUE" width={20} height={20} className="w-5 h-5 object-contain" />
