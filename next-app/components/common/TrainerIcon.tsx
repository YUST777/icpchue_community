...
export default function TrainerIcon({ className = "w-8 h-8", color = "#d59928" }: TrainerIconProps) {
    return (
        <svg
            className={className}
            viewBox="0 0 937 937"
