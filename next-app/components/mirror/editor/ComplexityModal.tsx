...
import { ComplexityResult } from '../shared/types';
            ...
            <div className="relative bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] border border-white/10 rounded-2xl p-6 max-w-lg w-full shadow-2xl animate-slide-up">
                ...
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#E8C15A]/20 to-[#E8C15A]/10 flex items-center justify-center border border-[#E8C15A]/20">
                ...
                {loading ? (
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {/* Time Complexity */}
                            <div className="relative overflow-hidden p-4 rounded-xl bg-gradient-to-br from-[#E8C15A]/10 to-transparent border border-[#E8C15A]/20">
                                <div className="absolute top-0 right-0 w-16 h-16 bg-[#E8C15A]/10 rounded-full blur-2xl" />
                                <div className="relative">
                                    <div className="flex items-center gap-2 mb-2">
                                        <Clock size={14} className="text-[#E8C15A]" />
                                        <span className="text-xs font-medium text-[#E8C15A]/80">Time</span>
                                    </div>
                        ...
                        <button
                            onClick={onClose}
                            className="w-full py-3 bg-gradient-to-r from-[#E8C15A] to-[#059669] hover:from-[#E8C15A] hover:to-[#E8C15A] text-white font-bold rounded-xl transition-all hover:shadow-lg hover:shadow-[#E8C15A]/20"
                        >
                            Got it!
                        </button>
                    </div>
